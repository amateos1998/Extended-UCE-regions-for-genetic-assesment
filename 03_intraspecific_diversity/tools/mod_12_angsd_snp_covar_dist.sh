...
--job-name=snpsAHwg \
--output=/export/home/a-e/amateos/phyluce_test_2/mapping_tests/logs/newref_angsd_ngsdist_logs/1AHYAwggatkAngsd_$1.log \
  /export/home/a-e/amateos/phyluce_test_2/mapping_tests/MOD_angsd_ngs_dist.slurm $1 \
  ...
  /export/home/a-e/amateos/phyluce_test_2/mapping_tests/results/12_ngs_dist_region/$2 $3 $4
}

#Full dataset run for 5-80%, maxDepthInd4, GL2, no-minHWEpval and uisng a region-filter file. ANGSD v0.929.


submit3 ahya_WG ahyaSamples 1e-3 1
